...
INSERT INTO departamentos (id_departamento, nombre_departamento, id_director, id_localizacion)
	VALUES (90, 'Pruebas', NULL, 1150);

Da error porque esa localización no existe*/
...
/*7.1.9
DELETE FROM departamentos WHERE id_departamento=70;
No se puede eliminar porque hemos puesto una restricción */

/*7.1.10
Sucesos paranormales
-- ALTER TABLE departamentos ADD CONSTRAINT departamentos_fk2 FOREIGN KEY (id_director) REFERENCES empleados(id_empleado);
-- ALTER TABLE empleados DROP CONSTRAINT empleados_fk2;
DELETE FROM departamentos WHERE id_departamento=80;
